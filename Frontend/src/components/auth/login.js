    ...
    return(
        <div>
            ...
            <div className="loginpage">
                <form>
                    User Name:
                    <input className="inputmsg" type="text" placeholder="username"
                               ...
                               for(let i = 0; i < 10;i++) {
                                   if (username.value === users[i].username && password.value === users[i].address.street) {
                                       ...
                                       event.preventDefault(),
                                           getInfo(addUser,errorMsg,toMainPage,username,password,email,phone,zipcode,id,picturesrc,catchPhrase,flag)
                                   }
                               }
                               // eslint-disable-next-line no-unused-expressions
                               event.preventDefault(),
...
const getInfo=(addUser,errorMsg,toMainPage,username,password,email,phone,zipcode,id,picturesrc,catchPhrase,flag)=>{
